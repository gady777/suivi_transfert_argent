...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tranfert par tranche</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <section class="content">
      ...
      <div class="row">
          <div class="col">
            <a class="btn btn-primary" href="{{route('admin.transfer.tranche.new')}}">Créer
          ...
          <div class="col">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tous les transferts par tranche</h3>
              </div>
              <div class="card-body">
