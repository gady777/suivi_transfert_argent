            ...
            <div class="card">
              ...
              @endif
                <p>
                  ...
                  {{$t->user()->pseudo}}. <br>
                  Reste à recevoir: <strong>{{$t->solde}} {{$t->devise()->abbreviation}}</strong> <br>
                </p>
                <form method="post" action="{{route('admin.transfer.tranche.instance.new.post',['id'=>$t->id])}}">
                  ...
                  <div class="form-group">
                      ...
                      <input value="{{old('amount')}}" name="amount" min="10" type="number" 
                        class="form-control"
                      id="place" placeholder="Montant à payer pour cette tranche en ({{$t->devise()->abbreviation}})">
                  ...
                  <input type="hidden" name="type" value="reception">
                    ...
                    <input type="hidden" name="devise" value="{{$t->devise()->id}}">
                    {{--<div class="form-group">
                      <label for="v">Devise</label>
