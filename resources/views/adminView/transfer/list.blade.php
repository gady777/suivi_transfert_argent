...
@section('title')
  {{config('info.app_name')}} - Admin - Tranfert d'argent
@endsection
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Tranfert d'argent</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.home')}}">Accueil</a></li>
              <li class="breadcrumb-item active">Tranfert d'argent</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tous les transferts d'argent</h3>
              </div>
              <div class="card-body">
                {{--<p>
