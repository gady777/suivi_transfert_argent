...
@section('title')
  {{config('info.app_name')}} - Admin - Déposer de l'argent
@endsection
          ...
          <div class="col-md-8 col">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Dépôt dans le compte de {{$user->type_compte == 3 ? $user->pseudo : $user->nameSociete}}</h3>
              </div>
              ...
              <form method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="1">Montant à déposer</label>
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary"> <i class="fa fa-plus"></i> Déposer</button>
                </div>
