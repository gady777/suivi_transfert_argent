...
@section('title')
  {{config('info.app_name')}} - Admin - Données de réceptions - Nouvelle
@endsection
          ...
          <div class="col-md-8 col">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Ajouter une nouvelle méthode</h3>
              </div>
              ...
              <form method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div>
                        @include ("adminView.receive_pay_method._method")
                    </div>
                </div>
