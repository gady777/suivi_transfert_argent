...
@section('title')
  {{config('info.app_name')}} - Admin - Pays
@endsection
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col">
            <a class="btn btn-primary" href="{{route('admin.country.new')}}">Ajouter
              un nouveau pays</a>
          </div>
        </div> <br>
        <div class="row">
          <div class="col">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tous les pays</h3>
              </div>
              <div class="card-body">
                  ...
                  <tbody>
                    @forelse($countries as $c)
                      <tr>
                        ...
                        <td class="text-center">{{$c->devise()->abbreviation}}</td>
                        <td class="text-center">
                            <a title="Modifier" href="{{route('admin.country.edit',['id'=>$c->id])}}"
                              class="m-1 btn btn-info"> <i class="fas fa-edit"></i> </a>
                            <form class="d-inline" onsubmit="return confirm('{{config('info.confirm_operation')}}');"
                            action="{{route('admin.country.delete',['id'=>$c->id])}}" method="post">
                    ...
                    @empty
                    <tr>
                      <td colspan="9" class="text-center text-danger">Aucun pays</td>
                    </tr>
                    @endforelse
                  </tbody>
                </table>
