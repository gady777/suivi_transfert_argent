...
@section('title')
  {{config('info.app_name')}} - Admin - Rejeter une demande de retrait
@endsection
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Demande de retrait</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.home')}}">Accueil</a></li>
              <li class="breadcrumb-item"><a href="{{route('admin.withdraw.home')}}">Retrait</a></li>
          ...
          <div class="col-md-8 col">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Rejeter la demande de retrait</h3>
              </div>

              <form method="post" action="{{route('admin.withdraw.reject.post',['id'=>$demande->id])}}">
