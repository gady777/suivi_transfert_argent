...
@section ('title')
Recevoir de l'argent | Transfert d'argent rapide et sécurisé - Canada - Afrique
@endsection
            ...
            <div class="uk-container">
                <div class="uk-grid uk-flex uk-flex-center in-blog-1 in-article">
                    <div class="uk-width-1-1 in-figure-available">
                        <img class="uk-width-1-1 uk-border-rounded" src="{{asset('assets/img/get-money.jpg')}}" alt="Recevez de l'argent">
                    </div>
                    <div class="uk-width-3-4@m">
                        <article class="uk-card uk-card-default uk-border-rounded">
                            <div class="uk-card-body">

                                <h2 class="uk-margin-top uk-margin-medium-bottom">Recevez de l'argent</h2>
