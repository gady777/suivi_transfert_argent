...
<body>
    ...
    <header>
        ...
        <div class="uk-section uk-padding-remove-vertical in-header-inner uk-background-cover
         uk-background-top-center" style="background-image: url({{asset('assets/img/in-liquid-slide-bg.png')}});">
            @include('layout.menu')
        </div>
        <!-- header content end -->
    </header>
