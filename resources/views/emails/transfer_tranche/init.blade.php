                                                ...
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                         ...
                                                         Nouveau transfert par tranche de <strong>{{ $transfer->amount }} 
                                                         {{$depot->devise()->abbreviation}}</strong> pour vous.<br><br>
                                                         Type de transfert: <strong>{{$transfer->type}}</strong> <br><br>
                                                         Id transfert: {{$depot->id_transaction}}<br><br>
                                                      </div>
                                                   </td>
                                                </tr>
                                                <tr>
