                                                ...
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                         ...
                                                         Nouvel envoi de <strong>{{$instance->amount}} FCFA</strong> pour le transfert de
                                                        {{ $depot->amount }} 
                                                        ...
                                                        Informations de d'envoi: <strong>{{$instance->informations}}</strong> <br>
                                                        Montant d'envoi: <strong>{{$instance->amount}} FCFA</strong><br>
                                                        Date de l'opération: <strong>{{date("d-m-Y H:i",strtotime($instance->created_at))}}</strong><br><br>
                                                        
                                                        <p>
                                                           Bénéficicaire: <strong>{{$instance->recipient() ? ($instance->recipient()->name.' - '.$instance->recipient()->email):''}}</strong>
                                                        </p>

                                                        <strong>Statut du transfert par tranche</strong> <br>
                                                        SOLDE ENVOI RESTANT: <strong>{{$transfer->solde_envoi}} F CFA</strong> <br>
