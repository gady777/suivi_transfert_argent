                                                ...
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                         ...
                                                         Confirmation de réception de la tranche <strong>{{$instance->id_reception}}, {{$instance->amount}} {{$depot->devise()->abbreviation}}</strong>
                                                         pour le transfert par tranche de : <br>
                                                         {{ $depot->amount }} {{$depot->devise()->abbreviation}} initié par 
                                                         <strong>Transfert Union</strong> pour vous le 
                                                          {{$instance->pay_date}} <br><br>

                                                          Date réception: <strong>{{date('d-m-Y',strtotime($instance->valid_date_ok))}}</strong> <br>
                                                          <strong>Message</strong><br><br>
                                                          {{$instance->valid_message}}
