                                                ...
                                                <tr>
                                                   <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                      <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                         ...
                                                         <strong>Nous n'avons pas trouvé les informations de réception</strong> <br>
                                                         <p>
                                                           Bénéficicaire: <strong>{{$instance->recipient() ? ($instance->recipient()->name.' - '.$instance->recipient()->email):''}}</strong> <br>
                                                           Veuillez renseigner les informations de réceptions par <strong>{{$instance->method()->name}}</strong> pour ce bénéficiaire.
                                                        </p>
                                                         Envoi de <strong>{{$instance->amount}} FCFA</strong> 
