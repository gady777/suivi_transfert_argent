                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                ...
                                                Nouveau transfert de {{ $depot->amount }} 
                                                {{$depot->countryFrom()->devise()->abbreviation}} par 
                                                {{ $depot->author()->pseudo }}<br><br>

                                                Id transfert: <strong>{{$depot->id_transaction}}</strong><br><br>
                                                
                                                Frais: <b>{{ $depot->fee_amount }} {{$depot->countryFrom()->devise()->abbreviation}}</b> <br>
                                                Montant à envoyer: <b>{{$depot->receive_amount}} {{$depot->recipient()->country()->devise()->abbreviation}}</b> 

                                                <b>Méthode: </b><br>
                                                @php $meth = $depot->method(); @endphp
                                                @php $rr= $depot->recipient(); @endphp
                                                <b>{{$meth->name}}</b> <br>
                                                @if($meth->slug == "bank")
