                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                Votre transfert de {{ $transfer->amount }} {{$transfer->countryFrom()->devise()->abbreviation}} à 
                                                <strong>{{$transfer->recipient()->name}} {{$transfer->recipient()->fname}}</strong>
                                                est <span style="color:red;"> annulé.</span><br><br>

                                                Id transfert: <strong>{{$transfer->id_transaction}}</strong><br><br>
                                                
                                                <strong>Raison:</strong> {{$transfer->reject_raison}} <br>
                                                <strong>Date: </strong> {{date('d-m-Y H:i',strtotime($transfer->reject_at) )}} <br><br>
