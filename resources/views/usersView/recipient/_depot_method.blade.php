<div style="display:none;" class="meth-bank">
    <div class="form-group">
      <input type="text" 
        ...
        value="{{old('bank_name')??$r->bank_name}}">
    ...
    <div class="form-group">
        <input 
            ...
            value="{{old('account_name')??$r->account_name}}">
    ...
    <div class="form-group">
        <input 
            ...
            value="{{old('account_number')??$r->account_number}}">
...
<div style="display:none;" class="meth-interact">
    <div class="form-group">
        <textarea
            ...
            name="interact" 
            rows="1" 
            placeholder="Les informations du compte interact (Téléphone ou Email)">{{old('interact')??$r->interact}}</textarea>
...
<div style="display:none;" class="meth-mobile">
    <div class="form-group">
        <input 
            ...
            value="{{old('phone_number') ?? $r->phone_number}}">
    ...
    <div class="form-group">
        <input 
            ...
            value="{{old('phone_name') ?? $r->phone_name}}">
...
<div style="display:none;" class="meth-cash">
    <div class="form-group">
        <input 
            ...
            value="{{old('cash_name_fname') ?? $r->cash_name_fname}}">
