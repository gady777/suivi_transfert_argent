<div style="display:none;" class="meth-bank">
    <div class="form-group">
      <input type="text" 
        ...
        value="{{old('bank_name')??$meth_bank->bank_name??''}}">
    ...
    <div class="form-group">
        <input 
            ...
            value="{{old('account_name')??$meth_bank->account_name??''}}">
    ...
    <div class="form-group">
        <input 
            ...
            value="{{old('account_number')??$meth_bank->account_number??''}}">
...
<div style="display:none;" class="meth-interact">
    <div class="form-group">
        <input type="text" name="interact" 
         ...
         value="{{old('interact')??$meth_interact->interact??''}}">
...
<div style="display:none;" class="meth-mobile">
    <div class="form-group">
        <input 
            ...
            value="{{old('phone_number')??$meth_phone->phone_number??''}}">
    ...
    <div class="form-group">
        <input 
            ...
            value="{{old('phone_name')??$meth_phone->phone_name??''}}">
...
<div style="display:none;" class="meth-cash">
    <div class="form-group">
        <input 
            ...
            value="{{old('cash_name_fname')??$meth_cash->cash_name_fname??''}}">
    ...
    <div class="form-group">
        <input 
            ...
            value="{{old('cash_cni')??$meth_cash->cash_cni??''}}">
