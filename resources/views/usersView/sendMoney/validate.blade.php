...
<div class="profile-content">
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
            ...
            <form method="post" class="bg-offwhite py-5" action={{ route('u.send.confirm') }} >
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea required class="form-control p-3" name="message" rows="4"
                        placeholder="Motif">{{old('message')}}</textarea>
                    @error('message')
                ...
                <ul class="pager mt-4">
                    <li></li>
                    <li>
                        <button class="btn btn-default mr-0" type="submit">
