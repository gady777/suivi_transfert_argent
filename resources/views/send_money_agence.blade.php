...
@section ('title')
Envoyez de l'argent depuis une agence | Transfert d'argent rapide et sécurisé - Canada - Afrique
@endsection
            ...
            <div class="uk-container">
                <div class="uk-grid uk-flex uk-flex-center in-blog-1 in-article">
                    <div class="uk-width-1-1 in-figure-available">
                        ...
                        src="{{asset('assets/img/person-giving-cash-envelope.jpg')}}" alt="sample-image">
                    </div>
                    <div class="uk-width-3-4@m">
                        <article class="uk-card uk-card-default uk-border-rounded">
                            <div class="uk-card-body">

                                <h2 class="uk-margin-top uk-margin-medium-bottom">Envoyez de l'argent depuis une agence </h2>
                            ...
                            <a href="signup.html" class="uk-button uk-button-primary uk-border-rounded">Transférer de l'argent</a>
                            ...
                            <div class="uk-card-footer uk-clearfix">
                                <div class="uk-float-left in-article-tags">
                                    ...
                                    <a href="#" class="uk-link-muted">Transfert d'argent international</a>
                                </div>
                                ...
                                <a href="#" data-uk-tooltip="Share with Instragram" class="uk-label uk-border-pill in-brand-instagram"><i class="fab fa-instagram fa-sm"></i></a>
